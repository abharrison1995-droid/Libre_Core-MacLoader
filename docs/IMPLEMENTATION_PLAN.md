...
| EFI builder and CLI | `macloader/build/efi.py`, `build`/`validate`, staging, manifests, plan-bound extraction, structural/config validation and qualified-validator contract; builder unit tests; candidate source included | Hosted clean-checkout evidence and real G1/G2 ocvalidate/toolchain qualification remain pending |
